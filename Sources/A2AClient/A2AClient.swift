...
public final class A2AClient: @unchecked Sendable {
    ...
    public func messageSend(_ message: A2ACore.Message) async throws -> SendMessageResponse {
    ...
    public func messageStream(_ message: A2ACore.Message) -> AsyncThrowingStream<StreamResponse, Error> {
